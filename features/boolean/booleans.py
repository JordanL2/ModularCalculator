...
class BooleansFeature(Feature):
    ...
    def install(cls, calculator):
        ...
        calculator.add_op(OperatorDefinition('Boolean', '&', BooleansFeature.op_boolean_and, 1, 1, 'boolean'))
        calculator.add_op(OperatorDefinition('Boolean', '|', BooleansFeature.op_boolean_or, 1, 1, 'boolean'))
        calculator.add_op(OperatorDefinition('Boolean', '?', BooleansFeature.op_boolean_conditional, 1, [1, ':', 1], ['boolean', None, None]), {'units_normalise': False})
