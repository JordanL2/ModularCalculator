...
tests = [
    ...
    { 'test': r"36z1Z", 'expected': '36z1Z' },
    { 'test': r"-36z1Z", 'expected': '-36z1Z' },
    { 'test': r"dec(-36z1Z)", 'expected': Decimal('-71') },
    { 'test': r"36Z1z", 'expected': '36z1Z' },
    { 'test': r"4z1.2", 'expected': '4z1.2' },
    { 'test': r"dec(4z1.2)", 'expected': Decimal('1.5') },
    { 'test': r"2z100", 'expected': '2z100' },
    { 'test': r"2Z100", 'expected': '2z100' },
    { 'test': r"2Z0", 'expected': '2z0' },
    { 'test': r"02Z0", 'expected': '2z0' },
    { 'test': r"002Z0", 'expected': '2z0' },
    { 'test': r"2Z000", 'expected': '2z0' },
    { 'test': r"dec(36z1Z)", 'expected': Decimal('71') },
    { 'test': r"dec(36Z1z)", 'expected': Decimal('71') },
    { 'test': r"dec(2z100)", 'expected': Decimal('4') },
    { 'test': r"dec(2Z100)", 'expected': Decimal('4') },
    ...
    { 'test': "datedifference('2012-01-02-0200', '2012-01-02T11:45:56.123456+0100', microseconds)", 'expected': (Decimal('31556123456'), 'microseconds') },
