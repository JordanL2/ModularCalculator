...
class TestBooleanBooleans(CalculatorTestCase):
    ...
    tests = [
        ...
        { 'test': r"true != 1", 'expected': False },
        { 'test': r"true != 0", 'expected': True },
        { 'test': r"false != 0", 'expected': False },
        { 'test': r"123.00 != 123", 'expected': False },
        { 'test': r"'123' != 123", 'expected': False },
        { 'test': r"'123.00' != 123", 'expected': False },
        { 'test': r"('123' + 0) != 123", 'expected': False },
        { 'test': r"'123' != (123 +$ '')", 'expected': False },

        { 'test': r"123 < 14", 'expected': False },
        { 'test': r"12 < 14", 'expected': True },
        { 'test': r"14 < 14", 'expected': False },
        { 'test': r"12 <= 14", 'expected': True },
        { 'test': r"14 <= 14", 'expected': True },
        { 'test': r"16 <= 14", 'expected': False },
        { 'test': r"123 > 14", 'expected': True },
        { 'test': r"12 > 14", 'expected': False },
        { 'test': r"14 > 14", 'expected': False },
        { 'test': r"12 >= 14", 'expected': False },
        { 'test': r"14 >= 14", 'expected': True },
        { 'test': r"16 >= 14", 'expected': True },
