...
class TestNumericalSpecialFunctions(CalculatorTestCase):
    ...
    tests = [
        ...
        { 'test': r"sp_btdtria(0.5, 0.5, 0.5)", 'expected': Number('9007199254740991', '18014398509481984') },
        { 'test': r"sp_btdtrib(0.5, 0.5, 0.5)", 'expected': Number('4503599627370493', '9007199254740992') },
        { 'test': r"sp_fdtr(1, 1, 0)", 'expected': Number(0) },
        { 'test': r"sp_fdtrc(1, 1, 0.5)", 'expected': Number('2738969713651587', '4503599627370496') },
        { 'test': r"sp_fdtri(1, 0.5, 0.5)", 'expected': Number('5436325649948141', '2251799813685248') },
        ...
        { 'test': r"sp_gdtria(0.5, 0.5, 1)", 'expected': Number('8195406022554283', '36028797018963968') },
        { 'test': r"sp_gdtrib(0.5, 0.5, 0.5)", 'expected': Number('592263610476285', '1125899906842624') },
        ...
        { 'test': r"sp_ncfdtri(1, 0.5, 0.5, 0.5)", 'expected': Number('4268992424480089', '1125899906842624') },
        { 'test': r"sp_ncfdtrinc(0.5, 1, 0.5, 1)", 'expected': Number(267039946906795, 562949953421312) },
        { 'test': r"sp_nctdtr(1, 0.5, 1)", 'expected': Number('2669498484956021', '4503599627370496') },
        ...
        { 'test': r"sp_nctdtrit(1, 1, 0.5)", 'expected': Number('5945711222452135', '4503599627370496') },
        ...
        { 'test': r"sp_log_ndtr(0.5)", 'expected': Number('-1661586938413673', '4503599627370496') },
        ...
        { 'test': r"sp_stdtr(0.5, 0.5)", 'expected': Number('87445966620235', '140737488355328') },
        { 'test': r"sp_stdtridf(0.5, 0)", 'expected': Number(5) },
        { 'test': r"sp_stdtrit(1, 0.5)", 'expected': Number('0') },
        { 'test': r"sp_chdtr(0, 1)", 'expected': Number(1) },
        { 'test': r"sp_chdtrc(0.5, 0)", 'expected': Number(1) },
        { 'test': r"sp_chdtri(1, 1)", 'expected': Number(0) },
        { 'test': r"sp_chdtriv(0.5, 0.5)", 'expected': Number('592263610476285', '562949953421312') },
        { 'test': r"sp_chndtr(1, 0.5, 1)", 'expected': Number('680095719155585', '1125899906842624') },
        { 'test': r"sp_chndtridf(0, 0.5, 0)", 'expected': Number('1', '') },
        { 'test': r"sp_chndtrinc(0.5, 1, 0.5)", 'expected': Number('6857945022224599', '72057594037927936') },
        { 'test': r"sp_chndtrix(0.5, 1, 0)", 'expected': Number('8195406022554295', '18014398509481984') },
        ...
        { 'test': r"sp_gammasgn(1)", 'expected': Number(1) },
        ...
        { 'test': r"sp_expi(1)", 'expected': Number('4267425945781893', '2251799813685248') },
