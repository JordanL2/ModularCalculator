...
class TestNumericalStatisticalFunctions(CalculatorTestCase):
    ...
    tests = [
        ...
        { 'test': r"min(2.1, 2.11, 2.09)", 'expected': Number('2.09') },
        { 'test': r"min(-2.1, -2.11, -2.09)", 'expected': Number('-2.11') },
        ...
        { 'test': r"max(2.1, 2.11, 2.09)", 'expected': Number('2.11') },
        { 'test': r"max(-2.1, -2.11, -2.09)", 'expected': Number('-2.09') },
