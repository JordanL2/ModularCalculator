...
class TestScientificCalculator(CalculatorTestCase):
    ...
    tests = [
        ...
        { 'test': r"sp_itairy_apt(0.5)", 'expected': Number(5258521996916253, 36028797018963968) },
        { 'test': r"sp_itairy_bpt(0)", 'expected': Number(0) },
        { 'test': r"sp_itairy_ant(0.5)", 'expected': Number(7523156804564241, 36028797018963968) },
        { 'test': r"sp_itairy_bnt(1)", 'expected': Number(104991576399771, 281474976710656) },
        ...
        { 'test': r"sp_hankel1(0.5, -1)", 'expected': Number(-3882993402734803, 9007199254740992) },
        { 'test': r"sp_hankel1e(-1, -1)", 'expected': Number(7558978089995349, 18014398509481984) },
        { 'test': r"sp_hankel2(0.5, 1)", 'expected': Number(6047403920203205, 9007199254740992) },
        ...
        { 'test': r"sp_yvp(0.5, 0.5)", 'expected': Number(53875002625279, 35184372088832) },
        { 'test': r"sp_ivp(-1, 1)", 'expected': Number(1578301742562423, 2251799813685248) },
        { 'test': r"sp_h1vp(0.5, 0.5)", 'expected': Number(505835404625755, 1125899906842624) },
        { 'test': r"sp_h2vp(0.5, -1)", 'expected': Number(3994450310785307, 4503599627370496) },
        ...
        { 'test': r"sp_btdtria(0.5, 0.5, 0.5)", 'expected': Number(4503599628804417, 9007199254740992) },
        { 'test': r"sp_btdtrib(0.5, 1, 0.5)", 'expected': Number(1076147000305025, 549755813888) },
        ...
        { 'test': r"sp_nbdtrin(0, 0.5, 0.5)", 'expected': Number(2251799813686751, 2251799813685248) },
        ...
        { 'test': r"sp_ncfdtridfn(0.5, 1, 0.5, 1)", 'expected': Number(537471413371387, 1125899906842624) },
        { 'test': r"sp_ncfdtri(1, 0.5, 0.5, 0.5)", 'expected': Number(8538045056297507, 2251799813685248) },
        { 'test': r"sp_ncfdtrinc(0.5, 1, 0.5, 1)", 'expected': Number(267039946893443, 562949953421312) },
        ...
        { 'test': r"sp_nrdtrisd(0, 0.5, 0.5)", 'expected': Number(7532400716397252) },
        ...
        { 'test': r"sp_stdtr(0.5, 0.5)", 'expected': Number(2798270931847519, 4503599627370496) },
        { 'test': r"sp_stdtridf(0.5, 0)", 'expected': Number(5) },
        { 'test': r"sp_stdtrit(1, 0.5)", 'expected': Number(101233323801, 1237940039285380274899124224) },
        { 'test': r"sp_chdtr(0, 1)", 'expected': Number(1) },
        { 'test': r"sp_chdtrc(0.5, 0)", 'expected': Number(1) },
        { 'test': r"sp_chdtri(1, 1)", 'expected': Number(0) },
        { 'test': r"sp_chdtriv(0.5, 0.5)", 'expected': Number(2369054441967531, 2251799813685248) },
        ...
        { 'test': r"sp_chndtrinc(0.5, 1, 0)", 'expected': Number(6948913452799753, 17592186044416) },
