...
tests = [
    ...
    { 'test': r"log(5)", 'expected': Number('1.609437912434100281799942422367') },
    { 'test': r"log(5, 10)", 'expected': Number('0.698970004336018746471381746233') },
    ...
    { 'test': r"3 meters to feet", 'expected': (Number('9.842519685039370078740157480315'), 'feet') },
    { 'test': r"3.5 meters to feet", 'expected': (Number('11.482939632545931758530183727034'), 'feet') },
    { 'test': r"0.035 meters to feet", 'expected': (Number('0.11482939632545931758530183727'), 'feet') },
    { 'test': r"-0.035 meters to feet", 'expected': (Number('-0.11482939632545931758530183727'), 'feet') },
    ...
    { 'test': r"(2 meters * 3 meters) / 2 feet", 'expected': (Number('9.842519685039370078740157480315'), 'meters') },
    { 'test': r"(2 meters * 3 meters * 4 meters) / (5 feet * 6 feet)", 'expected': (Number('8.61112833336777784666680444472'), 'meters') },
    ...
    { 'test': r"2 m/s to miles/hour", 'expected': (Number('4.473872584108804581245526127416'), 'miles/hour') },
    ...
    { 'test': r"compact(40 TW h / yr)", 'expected': (Number('4.563178344980846058896942898668'), 'gigawatts') },
    { 'test': r"0.004563084645220168834131873146 TW to TW h / yr", 'expected': (Number('39.99917864476386036960985626067'), 'terawatt hours/year') },
    { 'test': r"40 TW h / yr to MW", 'expected': (Number('4563.17834498084605889694289866778'), 'megawatts') },
    { 'test': r"40 TW h / yr to W", 'expected': (Number('4563178344.980846058896942898667780082183'), 'watts') },
    ...
    { 'test': r"100 mi / 2 knots", 'expected': (Number('43.448812095032397408207343412527'), 'hours') },
