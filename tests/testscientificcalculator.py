...
tests = [
    ...
    { 'test': r"1.234e1", 'expected': Decimal('12.34') },
    { 'test': r"1.234e10", 'expected': Decimal('12340000000') },
    { 'test': r"1.234e2", 'expected': Decimal('123.4') },
    { 'test': r"1.234e0", 'expected': Decimal('1.234') },
    { 'test': r"1.234e-1", 'expected': Decimal('0.1234') },
    { 'test': r"1.234e-2", 'expected': Decimal('0.01234') },
